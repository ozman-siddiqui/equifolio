...
alter table public.user_financial_profiles
  drop constraint if exists user_financial_profiles_groceries_household_non_negative,
  add constraint user_financial_profiles_groceries_household_non_negative
    check (groceries_household_monthly is null or groceries_household_monthly >= 0),
  drop constraint if exists user_financial_profiles_utilities_phone_internet_non_negative,
  add constraint user_financial_profiles_utilities_phone_internet_non_negative
    check (
      utilities_phone_internet_monthly is null
      or utilities_phone_internet_monthly >= 0
    ),
  ...
  drop constraint if exists user_financial_profiles_childcare_education_non_negative,
  add constraint user_financial_profiles_childcare_education_non_negative
    check (
      childcare_education_monthly is null
      or childcare_education_monthly >= 0
    ),
  ...
  drop constraint if exists user_financial_profiles_entertainment_lifestyle_non_negative,
  add constraint user_financial_profiles_entertainment_lifestyle_non_negative
    check (
      entertainment_lifestyle_monthly is null
      or entertainment_lifestyle_monthly >= 0
    ),
